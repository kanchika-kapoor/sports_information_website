...
const News = async ()=>{
    ...
    return (
        <div className="w-[350px] bg-[rgb-(40,46,58)] round-md px-2 md:px-6 py-2">
                    ...
                    legacyBehavior>
                        <a target="_blank">
                            <div className="relative w-full h-[150px] mb-4 group">
                                <Image src={
                                    news?.urlToImage !=null? news?.urlToImage: '/img/news-football.webp'
                                } alt={news.title}
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-2 z-10 bg-gradient-to-t from-zinc-900 to-transparent">
                                    <p className="font-semibold text-ld group-hover:text-teal-400">{news?.title}</p>
                                </div>
                            </div>
                        </a>
                    </Link>
